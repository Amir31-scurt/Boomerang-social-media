  ...
  const handleChangeBannerImage = async (event) => {
    ...
    if (file) {
      ...
      try {
        ...
        console.error('Error uploading banner image to Firebase Storage:', error);
      }
    }
  };
          ...
          <div className="Profil-img p-3">
            <div className="container my-3">
              ...
              <input
                ...
                />
                <img src={bannerImageUrl} alt="" className="img-fluid rounded-5 w-100 banner" />
              </div>
            </div>
          </div>
        ...
        <div className="my-4 bg-white shadaw-sm rounded-4">
          <div className="Publications p-3">
            <ul className="d-flex justify-content-around align-items-center list-unstyled">
              ...
              <li>
                <button
                  className={`rounded-5 border-0 ${activeTab === 'videos' ? 'act' : ''
                    }`}
              ...
              <li>
                <button
                  className={`rounded-5 border-0 ${activeTab === 'posts' ? 'act' : ''
                    }`}
